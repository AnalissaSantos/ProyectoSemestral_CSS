...
<!--    Encabezado de tabla-->
        <div class="Content-body">
            <div class="Content-body__item-header">
                <div>
                    <p class="Content-body__text-h1">Policlinica "Nombre Policlina"</p>
                    <p class="Content-body__text-p">Editar información de clinica</p>
                </div>
<!--                <div>-->
...
<!--            Nombre-->
            <div class="mb-3">
                ...
                <input id="Nombre_PolicInput" name="__Nombre_Polic" type="text" class="form-control"  value="Sutana Menagan" required>
            </div>
<!--            Direcccón -->
            <div class="mb-3">
