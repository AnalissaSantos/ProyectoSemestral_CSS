...
<div class="cover-container d-flex w-100 h-100 p-3 mx-auto flex-column">
    ...
    <div class="container">
        <div class="row justify-content-center" style="margin-top:10%">
            ...
            <h2>Su registro se agreó exitosamente</h2>
            <a style="margin-top: 1em" href="VistaAdministrador/Admin-Rol.php"><button class="btn btn-primary">De acuerdo</button></a>
        </div>
        <!--            </form>-->
    </div>
</div>
